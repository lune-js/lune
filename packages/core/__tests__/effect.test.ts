// oxlint-disable unicorn/no-new-array no-unused-expressions typescript/unbound-method
import { describe, expect, it, vi } from "bun:test";
import { test } from "bun:test";
import { effect, reactive, shallowReactive, stop, type ReactiveEffectRunner } from "../src";
import { TrackOpTypes, TriggerOpTypes } from "../src/constants";
import { ITERATE_KEY } from "../src/dep";
import { endBatch, startBatch } from "../src/system";
...
describe("effect", () => {
  ...
  it("should handle multiple effects", () => {
    let dummy1: number | undefined, dummy2: number | undefined;
    const counter = reactive({ num: 0 });
  ...
  it("should observe inherited property accessors", () => {
    let dummy: number | undefined, parentDummy: number | undefined, hiddenValue: any;
  ...
  it("should observe symbol keyed properties", () => {
    ...
    let dummy: string | undefined, hasDummy: boolean | undefined;
  ...
  it("should observe function valued properties", () => {
    ...
    // @ts-expect-error: Variable 'dummy' is used before being assigned.
  ...
  it("should not observe set operations without a value change", () => {
    let hasDummy: boolean | undefined, getDummy: string | undefined;
  ...
  it("should trigger all effects when array length is set to 0", () => {
    ...
    let dummy: number | undefined, record: number | undefined;
    effect(() => {
