...
describe("directives", () => {
  ...
  describe("lu-bind", () => {
    ...
    it("should bind a full object of attributes", async () => {
      container.innerHTML = '<div lu-bind="attrs"></div>';
    ...
    it("should bind true-value and false-value for checkboxes", async () => {
      container.innerHTML = '<input type="checkbox" :true-value="a" :false-value="b" lu-model="checked">';
    ...
    it("should handle object binding with all keys removed", async () => {
      container.innerHTML = '<div lu-bind="attrs"></div>';
      const data = reactive({
        attrs: { "data-test": "value" } as Record<string, string | undefined>
      });
      const app = createApp(data);
      app.mount(container);
      const div = container.querySelector("div")!;
  ...
  describe("lu-on", () => {
    it("should attach event handler", () => {
      container.innerHTML = '<button lu-on:click="handleClick">Click</button>';
  ...
  describe("lu-show", () => {
    it("should toggle display based on condition", async () => {
      container.innerHTML = '<div lu-show="isVisible">Content</div>';
  ...
  describe("lu-text", () => {
    it("should set text content", () => {
      container.innerHTML = '<div lu-text="message"></div>';
  ...
  describe("lu-html", () => {
    it("should set HTML content", () => {
      container.innerHTML = '<div lu-html="htmlContent"></div>';
  ...
  describe("lu-model", () => {
    it("should bind input value", () => {
      container.innerHTML = '<input lu-model="message">';
    ...
    it("should work with checkbox with array", async () => {
      container.innerHTML = `
        <input type="checkbox" value="a" lu-model="checked">
        <input type="checkbox" value="b" lu-model="checked">
      `;
    ...
    it("should work with radio buttons", async () => {
      container.innerHTML = `
        <input type="radio" value="a" lu-model="picked">
        <input type="radio" value="b" lu-model="picked">
      `;
    ...
    it("should work with .lazy modifier", async () => {
      container.innerHTML = '<input lu-model.lazy="message">';
    ...
    it("should work with textarea", () => {
      container.innerHTML = '<textarea lu-model="message"></textarea>';
    ...
    it("should work with select with number modifier", async () => {
      container.innerHTML = `
        <select lu-model.number="selected">
    ...
    it("should work with single checkbox", async () => {
      container.innerHTML = '<input type="checkbox" lu-model="checked">';
    ...
    it("should work with number input", async () => {
      container.innerHTML = '<input type="number" lu-model="value">';
    ...
    it("should work with trim modifier", async () => {
      container.innerHTML = '<input lu-model.trim="value">';
    ...
    it("should handle composition events", async () => {
      container.innerHTML = '<input lu-model="value">';
    ...
    it("should handle composition end when composing", () => {
      ...
      expect((input as any).composing).toBe(false);
      expect(mockDispatch).toHaveBeenCalledWith(expect.objectContaining({ type: "input" }));
    });
    ...
    it("should handle lazy modifier with number input type edge case", async () => {
      container.innerHTML = '<input type="number" lu-model.lazy="value">';
    ...
    it("should handle checkbox with custom true/false values and non-array model", async () => {
      container.innerHTML = '<input type="checkbox" :true-value="yes" :false-value="no" lu-model="checked">';
    ...
    it("should handle text input when not composing", () => {
      ...
      createValueHandler((val) => val)(input, assign);
    ...
    it("should work with select with multiple attribute", async () => {
      ...
      select.dispatchEvent(new Event("change"));
      await nextTick();
      expect(data.selected.sort()).toEqual(["option1", "option2", "option3"].sort());
    });

    it("should handle checkbox with array values", () => {
      container.innerHTML = `
        <input type="checkbox" lu-model="selected" value="option1" />
        <input type="checkbox" lu-model="selected" value="option2" />
        <input type="checkbox" lu-model="selected" value="option3" />
      `;
    ...
    it("should handle radio buttons", () => {
      container.innerHTML = `
        <input type="radio" lu-model="selected" value="option1" />
        <input type="radio" lu-model="selected" value="option2" />
        <input type="radio" lu-model="selected" value="option3" />
      `;
    ...
    it("should handle number modifier", () => {
      container.innerHTML = '<input lu-model.number="count" />';
    ...
    it("should handle trim modifier", () => {
      container.innerHTML = '<input lu-model.trim="message" />';
  ...
  describe("lu-ref", () => {
    ...
    it("should update ref when expression changes", async () => {
      container.innerHTML = '<div lu-ref="refName"></div>';
  ...
  describe("lu-for", () => {
    it("should render list items", () => {
      container.innerHTML = `
        <div lu-for="item in items" :key="item.id">
          {{ item.name }}
        </div>
      `;
    ...
    it("should handle object iteration", () => {
      container.innerHTML = `
        <div lu-for="(value, key) in obj" :key="key">
          {{ key }}: {{ value }}
        </div>
      `;
    ...
    it("should handle array with index", () => {
      container.innerHTML = `
        <div lu-for="(item, index) in items" :key="index">
          {{ index }}: {{ item }}
        </div>
      `;
    ...
    it("should handle object iteration with index", () => {
      container.innerHTML = `
        <div lu-for="(value, key, index) in obj" :key="key">
          {{ index }}: {{ key }}: {{ value }}
        </div>
      `;
    ...
    it("should handle nested object iteration", () => {
      container.innerHTML = `
        <div lu-for="(value, key) in obj" :key="key">
          <span lu-for="(nestedValue, nestedKey) in value" :key="nestedKey">
    ...
    it("should handle dynamic list updates", async () => {
      container.innerHTML = `
        <div lu-for="item in items" :key="item">
          {{ item }}
        </div>
      `;
    ...
    it("should handle array destructuring", () => {
      container.innerHTML = `
        <div lu-for="[a, b], index in items" :key="index">
          {{ a }}, {{ b }}
        </div>
      `;
    ...
    it("should handle object destructuring", () => {
      container.innerHTML = `
        <div lu-for="{name, age} in items" :key="name">
          {{ name }}: {{ age }}
        </div>
      `;
    ...
    it("should handle lu-for block reuse when keys change completely", async () => {
      container.innerHTML = `
        <div lu-for="item in items" :key="item.id">
          {{ item.name }}
        </div>
    ...
    it("should handle lu-for as last element in container", () => {
      container.innerHTML = `<div lu-for="item in items">{{ item }}</div>`;
  ...
  describe("lu-for integration tests", () => {
    it("should handle complex list reordering efficiently", async () => {
      container.innerHTML = `
        <ul>
          <li lu-for="item in items" :key="item.id" :data-id="item.id">
            {{ item.name }}
          </li>
        </ul>
      `;
    ...
    it("should handle mixed reordering with insertions and removals", async () => {
      container.innerHTML = `
        <div>
          <div lu-for="user in users" :key="user.id" class="user-card">
      ...
      const names = Array.from(users).map((el) => el.querySelector(".name")?.textContent?.trim());
      const emails = Array.from(users).map((el) => el.querySelector(".email")?.textContent?.trim());
  ...
  describe("lu-effect", () => {
    it("should run effect when mounted", async () => {
      container.innerHTML = '<div lu-effect="sideEffect()"></div>';
